...
def load_logo():
    ...
    relative to the project root. This works regardless of
    the current working directory (CPU or GPU launch).
    """
...
# -----------------------------
# Top banner disclaimer (NEW)
# -----------------------------
# st.markdown("""
# <div style="padding:10px; background-color:#ffe9e9; border-left: 6px solid #c60000;">
# <b>Disclaimer:</b><br>
# This demonstration is part of the patent-pending SoJen.AI system and is provided for evaluation only.<br>
# The underlying architecture and flows are confidential intellectual property.<br>
# <strong>Please do not share this link externally.</strong>
# </div>
# """, unsafe_allow_html=True)
...
4. You will receive a **JenAI-Moderator response**, offering a clearer, calmer, or more constructive version of your message.
5. Try different tones — **neutral, frustrated, confused, overwhelmed, dismissive, emotional** — and see how the system responds.
6. All processing is done via the SoJen.AI **ML + Generative AI engine**, which powers both our commercial API and our 
